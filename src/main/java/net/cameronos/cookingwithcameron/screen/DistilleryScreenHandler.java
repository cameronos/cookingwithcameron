...
import net.cameronos.cookingwithcameron.screen.slot.ModFuelSlot;
import net.cameronos.cookingwithcameron.screen.slot.ModResultSlot;
import net.cameronos.cookingwithcameron.block.custom.DistilleryBlock;
...
import static net.cameronos.cookingwithcameron.block.custom.DistilleryBlock.isCraftingTicks;
...
public class DistilleryScreenHandler extends ScreenHandler {
    ...
    public DistilleryScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        super(ModScreenHandlers.DISTILLERY_SCREENHANDLER, syncId);
    ...
    public boolean isCrafting() {
        isCraftingTicks = !isCraftingTicks; //sets false to true
