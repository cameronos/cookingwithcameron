...
public class DistilleryScreen extends HandledScreen<DistilleryScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(CookingWithCameron.MOD_ID, "textures/gui/distillery_gui.png");
    ...
    protected void init() {
        super.init();
        titleX = (backgroundWidth - textRenderer.getWidth(title)) / 10; //keep pushing ints or leave at 2
    }
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        if(handler.hasFuel()) {
            drawTexture(matrices, x + 20, y + 24 + 14 - handler.getScaledFuelProgress(), 176,
