...
public class ToasterBlock extends Block {
    ...
    private static final VoxelShape SHAPE_N = Block.createCuboidShape(4, 0, 2, 12, 7, 13);
    private static final VoxelShape SHAPE_E = Block.createCuboidShape(2, 0, 4, 13, 7, 12);
    @Override
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        tooltip.add(new TranslatableText("block.cookingwithcameron.toaster.tooltip"));
    }
}